...
*
* DESCRIPTION
* Gradbook database with a gui editor/viewer
*
 ...
 */
public class Main {
    final private int NUM_HOMEWORKS = 5;
    final private int NUM_EXAMS = 5;
    ...
    try{
      ...
      getView().messageBox("Cound not open gradebook.dat for writing. Exiting without saving.");
      System.exit(-1);
    }
  }
